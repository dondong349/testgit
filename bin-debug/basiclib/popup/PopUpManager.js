...
(function (basic) {
    var PopUpManager = (function () {
        ...
        //显示对话框
        p.addPopUp = function (target, effectClazz, effectParams, modalTouchFun, modal) {
            if (effectClazz === void 0) { effectClazz = null; }
            if (effectParams === void 0) { effectParams = null; }
            if (modalTouchFun === void 0) { modalTouchFun = null; }
            if (modal === void 0) { modal = true; }
        ...
        //移除界面
        p.removePopUp = function (target, effectClazz, effectParams) {
            if (effectClazz === void 0) { effectClazz = null; }
            if (effectParams === void 0) { effectParams = null; }
            //判断是否显示
            if (!target.parent) {
        ...
        p.getInStack = function (target, del) {
        ...
        p.createEffectInstance = function (effectClazz) {
            if (effectClazz === void 0) { effectClazz = null; }
            var effect;
            if (effectClazz) {
        ...
        //设置遮罩显示
        p.setModalMaskVisible = function (visible, index) {
    ...
    egret.registerClass(PopUpManager,'basic.PopUpManager');
})(basic || (basic = {}));
