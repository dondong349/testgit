...
(function (basic) {
    ...
    (function (dialogEffect) {
        ...
        egret.registerClass(Utils,'basic.dialogEffect.Utils');
        /***
         * 无效果
         */
        var None = (function () {
            ...
            p.show = function (target, parent, callback, thisObj, params) {
                parent.addChild(target);
                Utils.centerPopUp(target);
            };
            p.hide = function (target, parent, callback, thisObj, params) {
                parent.removeChild(target);
            };
            return None;
        })();
        dialogEffect.None = None;
        egret.registerClass(None,'basic.dialogEffect.None',["basic.dialogEffect.IDialogEffect"]);
        /***
         * 渐进渐出
         */
        var Fade = (function () {
        ...
        egret.registerClass(Fade,'basic.dialogEffect.Fade',["basic.dialogEffect.IDialogEffect"]);
        /**
         * 飞入
         * duration: 时间
        ...
        var Flew = (function () {
            ...
            var d = __define,c=Flew,p=c.prototype;
            p.show = function (target, parent, callback, thisObj, params) {
                if (!Flew.outPos) {
        ...
        egret.registerClass(Flew,'basic.dialogEffect.Flew',["basic.dialogEffect.IDialogEffect"]);
        /***
         * 缩放
         * duration: 时间
         * withFade: 是否伴随渐进渐出
        ...
        egret.registerClass(Scale,'basic.dialogEffect.Scale',["basic.dialogEffect.IDialogEffect"]);
