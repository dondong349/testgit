 ...
 *
 */
var HuDongMessage = (function (_super) {
    __extends(HuDongMessage, _super);
    function HuDongMessage() {
        _super.apply(this, arguments);
        this.now_showhead = "";
    }
    var d = __define,c=HuDongMessage,p=c.prototype;
    //初始化
    ...
    return HuDongMessage;
})(eui.Component);
egret.registerClass(HuDongMessage,'HuDongMessage');
